...
export default function MajlisScreen({ locale, initial }: Props) {
  ...
  if (!dash) {
    return (
      <main className="min-h-screen px-6 py-14 pb-28" dir={isAr ? "rtl" : "ltr"} style={{ background: "#080F08" }}>
  ...
  /* dashboard */
  return (
    <main className="min-h-screen pb-28" dir={isAr ? "rtl" : "ltr"} style={{ background: "#080F08" }}>
      <header
